...
author: "Daniel Ulloa y María José Calvo"
date: "2020-10-21"
output:
  html_document:
    theme: readable    
...
```{R}
#se extraen paises de Suramerica
paises_suramerica = world[world$continent == "South America"                            ,]

#data frame con filtro de area o población

paises_saareaypop = paises_suramerica[ paises_suramerica$area_km2 >= 2500000  |   paises_suramerica$pop >= 40000000                ,]

#plot de área
plot(
  paises_saareaypop["area_km2"], 
  main="
  
  Área de países de América del Sur con área de 
  al menos 2.5 millones de km2 o población de 
  al menos 40 millones de personas"
)

#plot de población
plot(
  paises_saareaypop["pop"], 
  main="
  
  Población de países de América del Sur con población de 
  al menos 40 millones de personas o área de 
...
Dado que no se entiende claramente la pregunta, se realiza esta segunda posible respuesta al ejercicio 9
```{r}


#Data frame con filtro de área
...
# data frame con filtro de población
